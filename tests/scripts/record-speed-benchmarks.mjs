...
function write() {
	...
	const lines = [
		...
		"modules `//!native` and `//!optimize 2`, but the code the transformer",
		"generates lives in each fixture's own module, which carries neither;",
		"serio has neither, and the baseline drops them on purpose to stay",
		"comparable with surge.",
