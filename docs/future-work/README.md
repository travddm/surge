...
| ---- | ---------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0    | [transformer-unit-test-coverage.md](transformer-unit-test-coverage.md) | The fixture harness (a stub `@rbxts/surge` and `@rbxts/types` in the transformer's tests, plus printed-emitter snapshots) comes first so every fix below lands with a regression test. The remaining test cases land with their fixes. |
