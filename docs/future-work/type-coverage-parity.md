...
| fixed widths                | u8..u32, i8..i32, f32, f64           | same                                    | same plus u12/u24/i12/i24/f8/f16/f24 (software)    | same plus f16 (software)                          | same                                         |
...
| functions, `symbol`, `null` | side, silently                       | side                                    | side                                               | n/a                                               | n/a                                          |
...
6. Wider and narrower numeric widths from serio: u24/i24 are cheap
   ...
   Add u24/i24 and f16; skip the 12-bit forms unless asked for.
