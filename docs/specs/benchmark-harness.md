...
Status: current
Applies to: `@rbxts/surge` at commit `e931e1b`, `rbxts-transformer-surge` at
...
- `e931e1b` / `ac69b4d`: removes 4.9 and the column; its one measurement is
  [../research/read-checks-cost.md](../research/read-checks-cost.md). Terms
  (Column) follows it.
